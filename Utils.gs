...
/**
 * Đảm bảo sheet có đủ số dòng/cột để ghi 1 khối dữ liệu lớn bằng setValues()
 * trong 1 lần gọi (getRange sẽ báo lỗi nếu range vượt quá kích thước hiện tại
 * của sheet). Gọi hàm này TRƯỚC khi setValues() cho 1 vùng có thể lớn hơn
 * kích thước hiện tại.
 */
